...
```{r}
# bar chart of sum of Bird.bites  for each colour Colour..B.RB.G. from dataset data
...
ggplot(data, aes(x=Colour..B.RB.G., y=Bird.bites)) + geom_bar(stat="identity") + xlab("Colour") + ylab("Number of Bird Bites") + scale_x_discrete(labels=c("B"="Brown", "RB"="Red/Black", "G"="Green")) + ggtitle("Bird Bites by Colour")
```

```{r}
# bar chart of sum of Insect.bites  for each colour Colour..B.RB.G. from dataset data
# label the x axis as Colour and the y axis as Number of Bird Bites
# rename the groups where B is Brown, RB is Red/Black and G is Green
# title the plot "Bird Bites by Colour"

ggplot(data, aes(x=Colour..B.RB.G., y=Insect.bites)) + geom_bar(stat="identity") + xlab("Colour") + ylab("Number of Insect Bites") + scale_x_discrete(labels=c("B"="Brown", "RB"="Red/Black", "G"="Green")) + ggtitle("Insect Bites by Colour")
```

```{r}
# bar chart of sum of Rodent.bites  for each colour Colour..B.RB.G. from dataset data
# label the x axis as Colour and the y axis as Number of Bird Bites
# rename the groups where B is Brown, RB is Red/Black and G is Green

ggplot(data, aes(x=Colour..B.RB.G., y=Rodent.bites)) + geom_bar(stat="identity") + xlab("Colour") + ylab("Number of Rodent Bites") + scale_x_discrete(labels=c("B"="Brown", "RB"="Red/Black", "G"="Green")) + ggtitle("Rodent Bites by Colour")
```

```{r}
# bar chart of sum of Snail.marks  for each colour Colour..B.RB.G. from dataset data
# label the x axis as Colour and the y axis as Number of Bird Bites
# rename the groups where B is Brown, RB is Red/Black and G is Green

ggplot(data, aes(x=Colour..B.RB.G., y=Snail.marks)) + geom_bar(stat="identity") + xlab("Colour") + ylab("Number of Snail Marks") + scale_x_discrete(labels=c("B"="Brown", "RB"="Red/Black", "G"="Green")) + ggtitle("Snail Marks by Colour")
```


To test the significance of this data a Chi Squared test was used to test the null hypothesis that the number of bites is the same for all three colourways within each bite type, at the 5% significance level. The results of this test are shown below:

**Birds:**
```{r}
# test the null hypothesis that the number of bites is the same for all three colourways within each bite type
# using the Chi Squared test

test <- chisq.test(table(data$Colour..B.RB.G., data$Bird.bites > 0))
```
...
test <- chisq.test(table(data$Colour..B.RB.G., data$Rodent.bites > 0))
```
...
test <- chisq.test(table(data$Colour..B.RB.G., data$Insect.bites > 0))
```
...
test <- chisq.test(table(data$Colour..B.RB.G., data$Snail.marks > 0))
```
